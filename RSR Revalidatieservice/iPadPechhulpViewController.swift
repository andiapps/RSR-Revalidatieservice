//
//  iPadPechhulpViewController.swift
//  RSR Revalidatieservice
//
//  Created by Diii workstation on 27/08/2017.
...
class iPadPechhulpViewController: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate {

    //
    @IBOutlet weak var map: MKMapView!
    let locManager = CLLocationManager()
    let span:MKCoordinateSpan = MKCoordinateSpanMake(0.05, 0.05) //zoom level setting
